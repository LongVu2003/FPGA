...
#create_clock -period "25.0 MHz" [get_pins {vga_cntrl|clkdiv}]
...
#create_generated_clock -name clk_div -source [get_pins {vga_cntrl|clkdiv}] -divide_by 2
...
set_false_path -from [get_ports ARDUINO_RESET_N*]
...
#set_false_path -to [get_pins vga_cntrl|clkdiv| clk]
#set_false_path -to [get_pins vga_cntrl|vs|clk]
